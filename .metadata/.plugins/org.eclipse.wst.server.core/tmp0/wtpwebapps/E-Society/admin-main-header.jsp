	...
	<div id="page-wrapper">
		<header role="banner"
			...
			<nav
				...
				<div class="s-12 l-2">
					<a href="admin-index.jsp" class="logo"> <!-- Logo version before sticky nav -->
				...
				<div class="s-12 l-10">
					<div class="top-nav right">
						...
						<ul class="right chevron">
							...
							<li><a href="admin-login.jsp">Sign in <i class="fa-solid fa-right-to-bracket fa-xs"></i></a></li>
							<li><a href="admin-register.jsp">Sing up <i class="fa-solid fa-user-plus fa-xs"></i></a></li>
						</ul>
					</div>
				</div>
			</nav>
